...
const StyledNavBar = styled.div`
    ...
    box-shadow: 0 0 1px 1px rgba(20,23,28,.1),0 3px 1px 1px rgba(20,23,28,.1);
    ...
    #styled-navbar-content {
        ...
        #styled-navbar-content-input-submit-btn {
            width: 4.5rem;
            height: 4.7rem;
    ...
    return (
        <StyledNavBar>
            <div id="styled-navbar-content">
                ...
                <Button btype="grey-button" text="Awsome" icon=" " />

                <div ud="navbar-divider"></div>

                <Button btype="white-button" text="Log In" icon=" " />
